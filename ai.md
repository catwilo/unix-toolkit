...
R9.2 CLIPBOARD: ALWAYS wrap { cmd; } 2>&1 | clipso. No exceptions. File write: { cat > ~/path << 'EOF'\n...\nEOF\n} 2>&1 | clipso. VIOLATION: bare command without wrapper when output expected. Exception: TTY-interactive (R9.10).
