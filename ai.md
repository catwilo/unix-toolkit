...
R9.40 TASK-QUALITY: every miko add -r must include: (1) tipo: BUG/FEAT/CHORE/DESIGN, (2) síntoma exacto reproducible, (3) causa raíz si conocida, (4) comando para reproducir si aplica, (5) comportamiento esperado. Tarea vaga o sin contexto = reescribir antes de agregar. Nunca agregar tareas placeholder ni a medias. Tareas mal redactadas = borrar con miko done + re-agregar correctas mismo turno.
