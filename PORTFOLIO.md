...
### [deadd-setup](https://github.com/catwilo/deadd-setup)
deadd-notification-center config installer and helper scripts. Extracted from minitools — manages deadd.sh, notifydeadd, and deploys a config template to the right place idempotently.
